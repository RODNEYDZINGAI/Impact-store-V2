...
const slides = [
  {
    id: 1,
    eyebrow: "IT hardware supplier South Africa",
    title: "Business technology for",
    highlight: "South African teams",
    subtitle:
      "Source laptops, ICT equipment, networking hardware, CCTV, access control, phones, tablets, and accessories with quote support for business procurement.",
    image: "/impact/evp/laptops3.jpg",
    cta: { label: "Browse Products", href: "/products" },
    ctaSecondary: { label: "Request a Quote", href: "/quote?source=homepage-hero" },
    chips: ["Business Procurement", "Nationwide Delivery", "Responsive Support"],
    floating: { label: "Supplier Support", detail: "Quote-led buying", icon: "truck" },
  ...
  },
  {
    ...
    ctaSecondary: { label: "Request Procurement Quote", href: "/quote?source=homepage-tap" },
  ...
  },
  {
    ...
    ctaSecondary: { label: "Quote a Team Rollout", href: "/quote?source=homepage-device-solutions" },
