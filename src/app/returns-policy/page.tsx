...
const returnSteps = [
  "Email support@impactstore.co.za with your order number, product details, photos where relevant, and a short description of the issue.",
          ...
          <div className="mt-10 space-y-8 text-ink">
            ...
            <section>
              ...
              <p className="mt-4 leading-relaxed">
                ...
                <a href="mailto:support@impactstore.co.za" className="font-semibold text-[#1f4f8f] hover:underline">
